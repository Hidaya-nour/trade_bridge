...
export default function DriverIssuesScreen() {
  ...
  return (
    <ScreenWrapper title="Delivery Issue Reporting" subtitle="Damaged, delay, failed attempt, breakdown">
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.chipContainer}>
          {(Object.keys(ISSUE_LABELS) as IssueType[]).map((it) => (
            ...
            >
              <Text style={[styles.chipText, selectedIssue === it && styles.chipTextActive]}>
                {ISSUE_LABELS[it]}
              </Text>
            </Pressable>
          ))}
...
const styles = StyleSheet.create({
  ...
  chip: { borderWidth: 1, borderColor: "#cbd5e1", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 7, backgroundColor: "#ffffff" },
  chipActive: { backgroundColor: "#eff6ff", borderColor: "#93c5fd" },
  chipText: { fontSize: 12, color: "#334155", fontWeight: "700" },
  chipTextActive: { color: "#1d4ed8" },
  button: { marginTop: 12, backgroundColor: "#1d4ed8", borderRadius: 10, paddingVertical: 11, alignItems: "center" },
  buttonDisabled: { backgroundColor: "#94a3b8" },
  buttonText: { color: "#ffffff", fontWeight: "700" },
  submittedList: { marginTop: 14, backgroundColor: "#f8fafc", borderRadius: 10, borderWidth: 1, borderColor: "#e2e8f0", padding: 12 },
  submittedTitle: { fontSize: 12, fontWeight: "700", color: "#0f172a", marginBottom: 6 },
