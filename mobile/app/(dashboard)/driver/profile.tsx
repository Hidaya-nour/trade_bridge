...
export default function DriverProfileScreen() {
  ...
  return (
    <ScreenWrapper title="Driver Profile" subtitle="Personal and vehicle summary">
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 12, padding: 12 },
