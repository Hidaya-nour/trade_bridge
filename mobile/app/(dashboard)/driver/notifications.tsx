...
export default function DriverNotificationsScreen() {
  ...
  return (
    <ScreenWrapper title="Driver Notifications" subtitle="Assignment & order update alerts">
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {NOTIFICATIONS.map((item) => (
          <View key={item.id} style={[styles.card, item.unread && styles.cardActive]}>
...
const styles = StyleSheet.create({
  ...
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#2563eb", position: "absolute", top: 12, right: 12 },
});