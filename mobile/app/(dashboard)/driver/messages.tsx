...
export default function DriverMessagesScreen() {
  return (
    <ScreenWrapper title="Driver Messages" subtitle="Distributor & buyer chat previews">
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.card}>
          <Text style={styles.title}>Messages</Text>
          <Text style={styles.text}>- Daniel (Distributor): Pickup updated</Text>
          <Text style={styles.text}>- Selam Supermarket (Buyer): Waiting at gate</Text>
