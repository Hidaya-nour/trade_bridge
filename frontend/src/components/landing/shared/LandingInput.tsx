...
const LandingInput = forwardRef<HTMLInputElement, LandingInputProps>(
  (
    {
      label,
      error,
    ...
    return (
      <div className={`relative ${containerClassName}`}>
        ...
        <input
          ...
          onFocus={handleFocus}
          onBlur={handleBlur}
          placeholder={shrinkLabel ? placeholder : ""}
          aria-invalid={Boolean(error) || undefined}
          className={`w-full h-16 bg-gray-50 border-2 ${
            error ? "border-red-400" : "border-gray-200"
          } rounded-2xl focus:border-purple-500 focus:outline-none focus:bg-white text-gray-800 transition-all duration-300 text-base ${inputClassName} ${paddingLeft} ${paddingRight}`}
          style={inputStyle}
          {...inputAttributes}
        />
